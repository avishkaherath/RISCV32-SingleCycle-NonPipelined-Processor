...
module InstructionMemory (
    ...
    always @(posedge clk) begin
        ...
        // memory[10] = 32'h407312b3; // MUL

        // // I-type Instructions
        // memory[0] = 32'hFF930293; // ADDI
        // memory[1] = 32'h00534293; // XORI
        // memory[2] = 32'h00537293; // ANDI
        // memory[3] = 32'h00536293; // ORI

        // // LOAD Instructions
        // memory[0] = 32'h00932283; // LW
        // memory[1] = 32'h00931283; // LH
        // memory[2] = 32'h00930283; // LB
        // memory[3] = 32'h00934283; // LBU
        // memory[4] = 32'h00935283; // LHU

        // // STORE Instructions
        // memory[0] = 32'h008324a3; // SW
        // memory[1] = 32'h008314a3; // SH
        // memory[2] = 32'h008304a3; // SB

        // B-type Instructions
        memory[0] = 32'h00731663; // BNE

        // // JALR Instruction
        // memory[0] = 32'h008302e7; // JALR
