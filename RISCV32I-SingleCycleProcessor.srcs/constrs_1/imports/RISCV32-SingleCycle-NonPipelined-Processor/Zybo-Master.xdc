...
create_clock -add -name sys_clk_pin -period 8.00 -waveform {0 4} [get_ports onboard_clk];
...
##Buttons
#set_property -dict { PACKAGE_PIN R18   IOSTANDARD LVCMOS33 } [get_ports rstPC]; #IO_L20N_T3_34 Sch=BTN0
